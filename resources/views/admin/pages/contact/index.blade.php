                ...
                <div style="margin-bottom: 24px; padding: 20px; background: #ffffff; border-radius: 12px; border: 1px solid #e5e7eb;">
                    <div style="display: flex; align-items: flex-start;">
                        ...
                        <div style="flex: 1;">
                            ...
                            <p style="font-size: 1rem; color: #1e293b; margin: 0; line-height: 1.6;">Elm Lodge Residential Care Home, Cluntergate, Horbury, Wakefield WF4 5DB</p>
                        </div>
                    </div>
                </div>
                ...
                <div style="margin-bottom: 24px; padding: 20px; background: #ffffff; border-radius: 12px; border: 1px solid #e5e7eb;">
                    <div style="display: flex; align-items: flex-start;">
                        ...
                        <div style="flex: 1;">
                            ...
                            <a href="mailto:manager@elmlodgecare.co.uk" style="font-size: 1rem; color: #3b82f6; text-decoration: none; font-weight: 500; transition: color 0.2s;">
                ...
                <div style="padding: 20px; background: #ffffff; border-radius: 12px; border: 1px solid #e5e7eb;">
                    <div style="display: flex; align-items: flex-start;">
                        ...
                        <div style="flex: 1;">
                            ...
                            <a href="tel:
019-242-62420" style="font-size: 1rem; color: #3b82f6; text-decoration: none; font-weight: 500; transition: color 0.2s;">
